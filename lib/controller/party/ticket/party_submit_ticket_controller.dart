...
class PartyGenerateTicketController extends GetxController {
  ...
  PartyGenerateTicketController({required this.ticketRepo});
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData.isNotEmpty) {
          ...
          partyCode.value = sharedPreferences.getString('VCODE') ?? '';
        } 
      } 
    } catch (e) {
      Get.snackbar('Error', 'Error fetching client info: $e',
