...
import 'package:getx_constants/view/party/tickets/party_client_info.dart';
import 'package:getx_constants/view/party/tickets/party_ticket_info.dart';

class PartyTicketHomeView extends StatelessWidget {
  final List<Widget> easyStepList = [
    PartyTicketInfoView(),
    PartyClientInfoView(),
  ];

   PartyTicketHomeView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PartyTicketController>(
      builder: (controller) {
        return Column(
          children: [
           Obx(
